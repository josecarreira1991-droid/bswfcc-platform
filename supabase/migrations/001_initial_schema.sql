...
INSERT INTO public.market_data (indicator, value, category, source) VALUES
  ...
  ('seaport_manatee_tons', '11,855,828', 'infraestrutura', 'Port Manatee FY2025 — RECORDE'),
  ('seaport_crescimento_yoy', '+8.2%', 'infraestrutura', 'Port Manatee FY2025'),
  ('seaport_importacoes_br', 'Suco de laranja, açúcar, etanol', 'infraestrutura', 'Port Manatee — Importações do Brasil'),
  ('seaport_exportacoes_br', 'Fosfato, maquinário, peças aeroespaciais', 'infraestrutura', 'Port Manatee — Exportações para Brasil'),
  ('aeroporto_rsw', 'RSW', 'infraestrutura', 'Lee County Port Authority'),
  ('sede_bswfcc_seaport', '1905 Intermodal Circle, Ste 320, Palmetto', 'infraestrutura', 'Endereço legal BSWFCC — no campus do SeaPort'),
  ('bones_coffee_hq', '$27M', 'desenvolvimento', 'Bones Coffee — Relocação corporativa de Broward para Cape Coral'),
  ('coral_grove', '$500M+', 'desenvolvimento', 'Coral Grove — Desenvolvimento mixed-use 131 acres Cape Coral'),
  ('igreja_lagoinha', 'Fort Myers', 'desenvolvimento', 'Principal hub da comunidade brasileira'),
