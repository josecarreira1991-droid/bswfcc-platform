        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input name="full_name" defaultValue={member.full_name} required className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
            <div>
              <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">Telefone</label>
              <input name="phone" defaultValue={member.phone || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
            <div>
              <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">Empresa</label>
              <input name="company" defaultValue={member.company || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
            <div>
              <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">Indústria</label>
              <input name="industry" defaultValue={member.industry || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
            <div>
              <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">Cidade</label>
              <input name="city" defaultValue={member.city || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
            <div>
              <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">LinkedIn</label>
              <input name="linkedin" defaultValue={member.linkedin || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none" />
            </div>
          </div>
          <div>
            <label className="block text-[11px] text-[#5A6577] uppercase tracking-wider mb-1">Bio</label>
            <textarea name="bio" rows={3} defaultValue={member.bio || ""} className="w-full px-3 py-2 text-sm bg-white border border-[#B8C4CE] rounded-lg text-[#1A1A2E] focus:border-accent focus:outline-none resize-none" />
          </div>
