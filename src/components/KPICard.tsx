...
export default function KPICard({ value, label, sublabel }: KPICardProps) {
  return (
    <div className="bg-white rounded-lg p-6 border border-corp-border hover:border-accent/20 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-accent/5">
